...
import type {AdvanceColors, ColorsSettingsType, ThemeCreatorState} from '../lib/types';
...
const themeCreatorReducer = (
    ...
    switch (action.type) {
        ...
        case 'updateAdvancedColors':
            return {
                ...newState,
                advancedColors: action.payload,
            };
        default:
            return prevState;
    }
