...
export function ApartmentCardPreview() {
    const [isFavorite, setIsFavorite] = useState(false);
    const theme = useTheme();

    const isLightTheme = theme.includes('light');

    const contrastBackgroundColor = isLightTheme ? 'rgba(0,0,0,0.05)' : 'rgba(255,255,255,0.1)';
    ...
    return (
        ...
        >
            ...
            >
                ...
                <Flex direction={'column'} gap={3} className={spacing({mt: 4, mb: 5})}>
                    <Text variant="header-1">
                        Luxury apartment with jacuzzi, center with parking, next to Starbucks
                    </Text>
                        ...
                        <Flex gap={3} alignItems="center">
                            ...
                            <Label theme="info" size="m">
                                <Flex alignItems="center" justifyContent="center" gap={1}>
                                    ...
                                    <div className={spacing({ml: 0.5})}>Guests recommend</div>
                                </Flex>
                            </Label>
                        </Flex>
                ...
                <Row space={5}>
                    <Col s={8}>
                        <Flex direction="column" gap={5} className={spacing({mb: 5})}>
                            ...
                            <Sheet>
                                ...
                                <div className={spacing({mb: 5})}>
                                    <CollapsibleText text={APARTMENT_MAIN_INFO.text} />
                                </div>

                                <SheetMailSubtitle>Main sleeping places</SheetMailSubtitle>
                                <SheetInfoItems items={APARTMENT_MAIN_INFO.mainSlepingPlaces} />
                            </Sheet>

                            <Sheet>
                                <SheetMailTitle>Object's posting rules</SheetMailTitle>
                                <SheetInfoItems
                                ...
                                <SheetList
                                    addBottomMargin
                                    itemsPerColumn={APARTMENT_MAIN_INFO.objectsPostingItems.length}
                            ...
                            <Sheet>
                                ...
                                <SheetList
                                    addBottomMargin
                                    itemsPerColumn={
                                        APARTMENT_MAIN_INFO.basicAmenitiesItems.length / 2
                                    }
                            ...
                            <Sheet>
                                ...
                                <Flex gap={9} className={spacing({mb: 5})}>
                                    {chunk(
                                        ...
                                        return (
                                            <Flex key={index} direction="column" grow={1} gap={3}>
                                    ...
                                    renderSelectedOption={(option) => {
                                        return (
                                            <Flex alignItems="center" gap={0.5}>
                                                <Text variant="subheader-1">Sort:</Text>
                                ...
                                <Flex direction="column" gap={5}>
                                    {APARTMENT_MAIN_INFO.reviews.map((review, index, arr) => {
                                        return (
                                            <Fragment key={index}>
                                                <Flex direction="column" gap={3}>
                                                    ...
                                                    >
                                                        <User
                                                            avatar={{
                                                                imgUrl: review.author.avatarScr,
                                                            }}
                                                            size="l"
                                                    ...
                                                    <Flex direction="column" gap={2}>
                                                        {review.points.map((point, pointIndex) => {
                                                            return (
                                                                <Flex key={pointIndex} gap={3}>
                                                                    <CollapsibleText
                                                                        text={point.text}
                                                                    />
                                                                    {point.state === 'positive' && (
                                                                        <Text color="positive">
                                                                            <Icon data={ThumbsUp} />
                                                                        </Text>
                                                                    )}
                                ...
                                <Button view="normal" size="l" className={spacing({mt: 5})}>
                                    Show more reviews
                                </Button>
                            </Sheet>
                        </Flex>
                        ...
                        <Flex direction="column" gap={5}>
                            <Sheet>
                                <Flex direction="column" gap={5}>
                                    <Flex direction="column" gap={4}>
                                        <Flex gap={4}>
                                            <DatePicker size="l" value={dateTime()} />
                                            <DatePicker
                                                size="l"
                                        ...
                                        <Select
                                            ...
                                            renderSelectedOption={(option) => {
                                                return (
                                                    <Flex gap={0.5}>
                                                        <Text variant="subheader-1">Guests:</Text>
                                                        <Text>{option.content}</Text>
                                                    </Flex>
                                                );
                                            }}
                                    ...
                                    <Flex direction="column" gap={1}>
                                        <Flex
                                            ...
                                            justifyContent="space-between"
                                        >
                                            <Text variant="subheader-1">for 8 nights:</Text>
                                            <Text variant="header-1">RUB 33,600</Text>
                                        </Flex>
                                        ...
                                        <Flex
                                            ...
                                            justifyContent="space-between"
                                        >
                                            <Text variant="body-1">Give precost today</Text>
                                            <Text variant="subheader-1">RUB 1,100</Text>
                                        </Flex>
                                        ...
                                        >
                                            ...
                                            <Text variant="subheader-1">RUB 1,500</Text>
                                        </Flex>
                                        ...
                                        <Flex
                                            ...
                                            justifyContent="space-between"
                                        >
                                            <Text variant="body-1">Pay of check-in</Text>
                                            <Text variant="subheader-1">RUB 31,000</Text>
                                        </Flex>

                                        <Divider />

                                        <Button size="s" view="flat" style={{margin: '0 auto'}}>
                                            More
                                    ...
                                    <Flex direction="column" gap={2}>
                                        <Text variant="subheader-1">Booking Phone</Text>

                                        <Flex>
                                            <Select
                                                size="l"
                                                options={[{value: '+7', content: '+7'}]}
                                                pin="round-clear"
                                                value={['+7']}
                                                renderSelectedOption={(value) => {
                                                    return (
                                                        <div className={spacing({mr: 3})}>
                                                            {value.content}
                                                        </div>
                                                    );
                                                }}
                                        ...
                                        <Text variant="body-1" color="secondary">
                                            We will send a confirmation code and booking information
                                        </Text>
                                    </Flex>

                                    <Flex>
                                        <Text>
                                            By clicking the Booking, you agree to the terms of the{' '}
                                            <Link href="#" underline>
                                                user agreement
                                            </Link>{' '}
                                            and to the{' '}
                            ...
                            <Card view="outlined" spacing={{p: 5}}>
                                <Flex direction="column" alignItems="center" gap={1}>
                                    ...
                                    <Text variant="subheader-3">+7 (000) 000-00-00</Text>
                                    <Text variant="body-1">When calling, call the ad number:</Text>
                    ...
                    <Row space={0}>
                        ...
                        <Col s={4}>
                            <Flex gap={3} direction="column">
                                <Text variant="subheader-3">Download application</Text>
                                <Flex gap={3}>
                                    <Card overflow="hidden" view="clear">
                                        ...
                                        >
                                            ...
                                            <Flex direction="column">
                                                <Text variant="caption-1" style={{color: 'white'}}>
                                                    Download on the
                                                </Text>
                                                <Text
                                                    variant="subheader-1"
                                    ...
                                    <Card overflow="hidden" view="clear">
                                        ...
                                        >
                                            ...
                                            <Flex direction="column">
                                                <Text variant="caption-1">GET IT ON</Text>
                                                <Text variant="subheader-1">Google Play</Text>
                                            </Flex>
                                        </Flex>
                                    </Card>
                                </Flex>
...
export function AppartmentActions() {
    return (
        <ActionBar.Item>
            <Flex gap={2} className={spacing({mr: 4})}>
                ...
                <Divider orientation="vertical" className={spacing({my: 1})} />
                <Text style={{alignSelf: 'center'}} variant="body-1">
                    +7 (000) 000-00-00
                </Text>
            </Flex>
        </ActionBar.Item>
