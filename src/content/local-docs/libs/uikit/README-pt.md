...
React 16.14, 17, 18 ou 19 deve estar instalado em seu projeto.
...
Inclua os estilos base e as fontes uma vez no topo do ponto de entrada do seu aplicativo:
...
Contribuições são bem-vindas! Por favor, leia o [CONTRIBUTING.md](CONTRIBUTING.md) antes de enviar um pull request. Para diretrizes detalhadas de PR, veja [contribute/pull-request.md](contribute/pull-request.md).
...
Participe da comunidade no [Telegram](https://t.me/gravity_ui) para perguntas e discussões.
...
- **Componentes renderizam sem estilo sem configuração.** Envolva o aplicativo com `ThemeProvider` **e** importe `@gravity-ui/uikit/styles/styles.css` (mais `fonts.css`) uma vez no ponto de entrada — ambos são necessários.
...
Se você achar o UIKit útil, por favor, considere dar uma ⭐ no [GitHub](https://github.com/gravity-ui/uikit) — isso ajuda outras pessoas a descobrirem o projeto.