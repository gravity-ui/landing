...
### Navegación de Cabecera Lateral &middot; [Vista previa →](https://preview.yandexcloud.dev/navigation/)
...
Utilizado para la tematización de los componentes de Navigation
